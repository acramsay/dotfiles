...
export const POLICY_PROMPT = [
  ...
  '- ok: {"decision":"allow"}',
  '- unsafe: {"decision":"deny","category":"DG1..DG7","reason":"one line","alternative":"safer command or null"}',
  "",
  ...
  "",
  "## SAFE — allow",
  "Normal developer ops: read-only lookups, builds, tests, git status/diff/log, boxed rm of a specific file, scoped cleanup within the project.",
  "",
...
type CacheEntry = { verdict: Verdict; ts: number }
